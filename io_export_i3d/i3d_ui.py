...
class I3D_FileExport(bpy.types.Operator, bpy_extras.io_utils.ExportHelper):
    ...
    I3D_exportSelected = bpy.props.BoolProperty(
        name="Export Selected", default=False)
...
class I3D_UIexportSettings(bpy.types.PropertyGroup):
    UI_settingsMode = bpy.props.EnumProperty(
                items=[('exp', 'Export', ''), ('attr', 'Attributes', '')],
                name="Settings Mode")
    UI_exportOptions = bpy.props.BoolProperty(
        name="Export Options", default=True)
    ...
    I3D_exportIK = bpy.props.BoolProperty(
        name="IK", default=dcc.SETTINGS_UI['I3D_exportIK']['defaultValue'])
    ...
    I3D_exportAxisOrientations = bpy.props.EnumProperty(
        items=[("BAKE_TRANSFORMS", "Bake Transforms", "Change axis Z = Y"),
               ("KEEP_AXIS", "Keep Axis",
               "Rotate Root objects on 90 degrees by X"),
               ("KEEP_TRANSFORMS", "Keep Transforms",
               "Export with no changes")],
        name="Axis Orientations", default="BAKE_TRANSFORMS")
    I3D_exportUseSoftwareFileName = bpy.props.BoolProperty(
        name="Use Blender Filename",
        default=dcc.SETTINGS_UI[
            'I3D_exportUseSoftwareFileName']['defaultValue'])
    ...
    I3D_solverIterationCount = bpy.props.IntProperty(
        ...
        default=dcc.SETTINGS_ATTRIBUTES[
            'I3D_solverIterationCount']['defaultValue'])
    ...
    I3D_splitUvWorldScale = bpy.props.FloatProperty(
        ...
        default=dcc.SETTINGS_ATTRIBUTES[
            'I3D_splitUvWorldScale']['defaultValue'])
    ...
    I3D_jointBreakTorque = bpy.props.FloatProperty(
        name="Break Torque",
        default=dcc.SETTINGS_ATTRIBUTES[
            'I3D_jointBreakTorque']['defaultValue'])
