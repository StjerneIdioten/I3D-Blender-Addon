...
class I3D_FileExport( bpy.types.Operator, bpy_extras.io_utils.ExportHelper ):
    ...
    bl_options = {'PRESET'}
    filename_ext = ".i3d"
    I3D_exportSelected = bpy.props.BoolProperty(name="Export Selected",
                                                default=False)
...
def draw(self, context):
    layout = self.layout
    layout.prop(context.scene.I3D_UIexportSettings,
                "UI_settingsMode", expand=True)
# -----------------------------------------
# "Export" tab
    ...
    # "Attributes" tab
        ...
        if context.scene.I3D_UIexportSettings.UI_rigidBody:
            ...
            col.label("Trigger")
            col = split.column()
            col.prop(context.scene.I3D_attributes,
                     "I3D_static", text="")
            col.prop(context.scene.I3D_attributes,
                     "I3D_kinematic", text="")
            col.prop(context.scene.I3D_attributes,
            ...
            col.prop(context.scene.I3D_attributes,
                     "I3D_compound", text="")
            col.prop(context.scene.I3D_attributes,
                     "I3D_compoundChild", text="")
            col.prop(context.scene.I3D_attributes,
                     "I3D_collision", text="")
            col.prop(context.scene.I3D_attributes,
                     "I3D_collisionMask", text="")
            col.prop(context.scene.I3D_attributes,
                     "I3D_restitution", text="")
            col.prop(context.scene.I3D_attributes,
                     "I3D_staticFriction", text="")
            col.prop(context.scene.I3D_attributes,
                     "I3D_dynamicFriction", text="")
            col.prop(context.scene.I3D_attributes,
                     "I3D_linearDamping", text="")
            col.prop(context.scene.I3D_attributes,
                     "I3D_angularDamping", text="")
            col.prop(context.scene.I3D_attributes,
                     "I3D_density", text="")
            col.prop(context.scene.I3D_attributes,
                     "I3D_skinWidth", text="")
            col.prop(context.scene.I3D_attributes,
                     "I3D_solverIterationCount", text="")
            col.prop(context.scene.I3D_attributes,
                     "I3D_ccd", text="")
            col.prop(context.scene.I3D_attributes,
                     "I3D_trigger", text="")
        ...
        if context.scene.I3D_UIexportSettings.UI_joint:
            ...
            col.prop(context.scene.I3D_attributes,
                     "I3D_driveForceLimit", text="")
            col.prop(context.scene.I3D_attributes, "I3D_driveSpring", text="")
            col.prop(context.scene.I3D_attributes,
                     "I3D_driveDamping", text="")
            col.prop(context.scene.I3D_attributes,
                     "I3D_breakableJoint", text="")
            col.prop(context.scene.I3D_attributes,
                     "I3D_jointBreakForce", text="")
            col.prop(context.scene.I3D_attributes,
                     "I3D_jointBreakTorque", text="")
        # -----------------------------------------
        # "Rendering" box
        box = layout.box()
        row = box.row()
        ...
        if context.scene.I3D_UIexportSettings.UI_rendering:
            ...
            col.prop(context.scene.I3D_attributes,
                     "I3D_receiveShadows", text="")
            col.prop(context.scene.I3D_attributes,
                     "I3D_nonRenderable", text="")
...
def exists(self):
    """
    True if self.currentNode exists and
    is currentNode of bpy.types.Object class
    """
...
def _save(self, obj):
    """
    take data from context.scene and
...
class I3D_UIexportSettings(bpy.types.PropertyGroup):
    ...
    UI_exportOptions = bpy.props.BoolProperty(name="Export Options",
                                              default=True)
    UI_shapeExportSubparts = bpy.props.BoolProperty(
        name="Shape Export Subparts", default=True)
    UI_miscellaneous = bpy.props.BoolProperty(
        name="Miscellaneous", default=True)
...
class I3D_export(bpy.types.PropertyGroup):
    ...
    I3D_exportUseBlenderFileName = bpy.props.BoolProperty(
        name="Use Blender Filename", default=True)
    I3D_exportFileLocation = bpy.props.StringProperty(
        name="File Location", subtype="FILE_PATH")
...
@classmethod
def unregister(cls):
    if bpy.context.scene.get('I3D_export'):
        del bpy.context.scene['I3D_export']
    try:
        del bpy.types.Scene.I3D_export
    except:
        pass
...
class I3D_attributes( bpy.types.PropertyGroup ):
    """
    PropertyGroup for the I3D_attributes Settings
    attached to the bpy.types.Scene
    """
    ...
    I3D_ccd = bpy.props.BoolProperty(
        name="Continues Collision Detection", default=False)
    ...
    I3D_projDistance = bpy.props.FloatProperty(
        name="Projection Distance", default=0.010)
    I3D_projAngle = bpy.props.FloatProperty(
        name="Projection Angle", default=0.010)
...
@classmethod
def unregister(cls):
    if bpy.context.scene.get('I3D_attributes'):
        del bpy.context.scene['I3D_attributes']
    try:
