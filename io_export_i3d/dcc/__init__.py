...
SETTINGS_ATTRIBUTES = {}
SETTINGS_ATTRIBUTES[
    'I3D_static'] = {'type': TYPE_BOOL, 'defaultValue': True}
SETTINGS_ATTRIBUTES[
    'I3D_dynamic'] = {'type': TYPE_BOOL, 'defaultValue': False}
SETTINGS_ATTRIBUTES[
    'I3D_kinematic'] = {'type': TYPE_BOOL, 'defaultValue': False}
SETTINGS_ATTRIBUTES[
    'I3D_compound'] = {'type': TYPE_BOOL, 'defaultValue': False}
SETTINGS_ATTRIBUTES[
    'I3D_compoundChild'] = {'type': TYPE_BOOL, 'defaultValue': False}
SETTINGS_ATTRIBUTES[
    'I3D_collision'] = {'type': TYPE_BOOL, 'defaultValue': True}
SETTINGS_ATTRIBUTES[
    'I3D_collisionMask'] = {'type': TYPE_INT, 'defaultValue': 255}
SETTINGS_ATTRIBUTES[
    'I3D_solverIterationCount'] = {'type': TYPE_INT, 'defaultValue': 4}
SETTINGS_ATTRIBUTES[
    'I3D_restitution'] = {'type': TYPE_FLOAT, 'defaultValue': 0}
SETTINGS_ATTRIBUTES[
    'I3D_staticFriction'] = {'type': TYPE_FLOAT, 'defaultValue': 0.5}
SETTINGS_ATTRIBUTES[
    'I3D_dynamicFriction'] = {'type': TYPE_FLOAT, 'defaultValue': 0.5}
SETTINGS_ATTRIBUTES[
    'I3D_linearDamping'] = {'type': TYPE_FLOAT, 'defaultValue': 0.0}
SETTINGS_ATTRIBUTES[
    'I3D_angularDamping'] = {'type': TYPE_FLOAT, 'defaultValue': 0.01}
...
SETTINGS_ATTRIBUTES[
    'I3D_splitMinU'] = {'type': TYPE_FLOAT, 'defaultValue': 0.0}
SETTINGS_ATTRIBUTES[
    'I3D_splitMinV'] = {'type': TYPE_FLOAT, 'defaultValue': 0.0}
SETTINGS_ATTRIBUTES[
    'I3D_splitMaxU'] = {'type': TYPE_FLOAT, 'defaultValue': 1.0}
SETTINGS_ATTRIBUTES[
    'I3D_splitMaxV'] = {'type': TYPE_FLOAT, 'defaultValue': 1.0}
SETTINGS_ATTRIBUTES[
    'I3D_splitUvWorldScale'] = {'type': TYPE_FLOAT, 'defaultValue': 1.0}
SETTINGS_ATTRIBUTES['I3D_joint'] = {'type': TYPE_BOOL, 'defaultValue': False}
SETTINGS_ATTRIBUTES[
    'I3D_projection'] = {'type': TYPE_BOOL, 'defaultValue': False}
SETTINGS_ATTRIBUTES[
    'I3D_projDistance'] = {'type': TYPE_FLOAT, 'defaultValue': 0.01}
SETTINGS_ATTRIBUTES[
    'I3D_projAngle'] = {'type': TYPE_FLOAT, 'defaultValue': 0.01}
SETTINGS_ATTRIBUTES[
    'I3D_xAxisDrive'] = {'type': TYPE_BOOL, 'defaultValue': False}
SETTINGS_ATTRIBUTES[
    'I3D_yAxisDrive'] = {'type': TYPE_BOOL, 'defaultValue': False}
SETTINGS_ATTRIBUTES[
    'I3D_zAxisDrive'] = {'type': TYPE_BOOL, 'defaultValue': False}
SETTINGS_ATTRIBUTES[
    'I3D_drivePos'] = {'type': TYPE_BOOL, 'defaultValue': False}
SETTINGS_ATTRIBUTES[
    'I3D_driveForceLimit'] = {'type': TYPE_FLOAT, 'defaultValue': 100000}
SETTINGS_ATTRIBUTES[
    'I3D_driveSpring'] = {'type': TYPE_FLOAT, 'defaultValue': 1.0}
SETTINGS_ATTRIBUTES[
    'I3D_driveDamping'] = {'type': TYPE_FLOAT, 'defaultValue': 0.01}
SETTINGS_ATTRIBUTES[
    'I3D_breakableJoint'] = {'type': TYPE_BOOL,  'defaultValue': False}
SETTINGS_ATTRIBUTES[
    'I3D_jointBreakForce'] = {'type': TYPE_FLOAT, 'defaultValue': 0.0}
SETTINGS_ATTRIBUTES[
    'I3D_jointBreakTorque'] = {'type': TYPE_FLOAT, 'defaultValue': 0.0}
SETTINGS_ATTRIBUTES['I3D_oc'] = {'type': TYPE_BOOL, 'defaultValue': False}
SETTINGS_ATTRIBUTES[
    'I3D_castsShadows'] = {'type': TYPE_BOOL, 'defaultValue': False}
SETTINGS_ATTRIBUTES[
    'I3D_receiveShadows'] = {'type': TYPE_BOOL, 'defaultValue': False}
SETTINGS_ATTRIBUTES[
    'I3D_nonRenderable'] = {'type': TYPE_BOOL, 'defaultValue': False}
SETTINGS_ATTRIBUTES[
    'I3D_clipDistance'] = {'type': TYPE_FLOAT, 'defaultValue': 0}
SETTINGS_ATTRIBUTES['I3D_objectMask'] = {'type': TYPE_INT, 'defaultValue': 255}
SETTINGS_ATTRIBUTES[
    'I3D_lightMask'] = {'type': TYPE_STRING, 'defaultValue': 'FFFF'}
...
SETTINGS_ATTRIBUTES[
    'I3D_mergeGroupRoot'] = {'type': TYPE_BOOL, 'defaultValue': False}
SETTINGS_ATTRIBUTES[
    'I3D_boundingVolume'] = {'type': TYPE_STRING, 'defaultValue': ''}
...
SETTINGS_UI[
    'I3D_exportNurbsCurves'] = {'type': TYPE_BOOL, 'defaultValue': False}
...
SETTINGS_UI[
    'I3D_exportParticleSystems'] = {'type': TYPE_BOOL, 'defaultValue': False}
SETTINGS_UI[
    'I3D_exportUserAttributes'] = {'type': TYPE_BOOL, 'defaultValue': True}
...
SETTINGS_UI[
    'I3D_exportSkinWeigths'] = {'type': TYPE_BOOL, 'defaultValue': True}
SETTINGS_UI[
    'I3D_exportMergeGroups'] = {'type': TYPE_BOOL, 'defaultValue': True}
SETTINGS_UI['I3D_exportVerbose'] = {'type': TYPE_BOOL, 'defaultValue': True}
SETTINGS_UI[
    'I3D_exportRelativePaths'] = {'type': TYPE_BOOL, 'defaultValue': True}
SETTINGS_UI[
    'I3D_exportUseSoftwareFileName'] = {
        'type': TYPE_BOOL, 'defaultValue': True}
SETTINGS_UI[
    'I3D_exportFileLocation'] = {'type': TYPE_STRING, 'defaultValue': ''}
...
def getNodeData(m_node):
    ...
    m_translation, m_rotation, m_scale =\
        dcc.getNodeTranslationRotationScale(m_node)
